...
> [!Duyuru]
> ​Değerli kullanıcılar,​İETTNext, İstanbul Büyükşehir Belediyesi (İBB) tarafından uygulanan idari baskılar ve veri erişim kısıtlamaları nedeniyle geçici olarak kapatılmıştır.
