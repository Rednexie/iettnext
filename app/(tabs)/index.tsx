  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#0d0d1a' }} contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.header}>
        <Text style={styles.headerText}>İETT Hizmetleri</Text>
      </View>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
          <Text onPress={() => Linking.openURL('https://github.com/Rednexie')} style={styles.footerLink}>Rednexie</Text> tarafından geliştirilmiştir,{' '}
          <Text onPress={() => Linking.openURL('https://deno.com/')} style={styles.footerLink}>Deno</Text> üzerinde hostlanmaktadır.
        </Text>
      </View>
    </ScrollView>
  );
